    ...
    <form action="{{ route('proveedor.store') }}" method="post">
        ...
        <div class="input-group mb-3">
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="input-group-addon" style="color:red; font-family: Verdana;">*</span>
                    <span class="fa fa-address-card {{ config('adminlte.classes_auth_icon', '') }}"></span>
                </div>
            </div>
            <input type="number" name="nit" class="form-control @error('nit') is-invalid @enderror"
                value="{{ old('nit') }}" placeholder="NIT">
