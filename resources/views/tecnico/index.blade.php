...
@section('title', 'Consultar Tecnicos')

@section('content_header')
    <h1 style="align-content: center">Consultar tecnicos</h1>
@stop
            ...
            <tr>
                ...
                <td>{{$tecnico->correo}}</td>
                 <td>
                    ...
                    <div class="col-sm-4">
                    <a href="{{ route('tecnico.edit', $tecnico->id)}}" class="btn btn-primary">Editar</a>
                    </div>
                    <div class="col-sm-4">
